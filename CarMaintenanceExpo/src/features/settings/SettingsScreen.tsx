...
import { View, ScrollView, StyleSheet, StatusBar, Alert, TouchableOpacity, Text, Modal } from 'react-native';
...
import { VehicleFormScreen } from '@/features/vehicle';
...
export const SettingsScreen: React.FC<SettingsScreenProps> = ({ onClose }) => {
  ...
  const handleVehicleFormSuccess = useCallback(async () => {
